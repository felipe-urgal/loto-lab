...
- [`ADVANCED_STRUCTURE_OWNER.md`](ADVANCED_STRUCTURE_OWNER.md) — owner de estrutura/filtros metodológicos em implementação na branch `refactor/62-analysis-structure-owner`.

Próximo foco: concluir a extração mecânica do owner de estrutura sem alterar metodologia ou expected values; depois reavaliar o hotspot restante antes de escolher outra seam.
