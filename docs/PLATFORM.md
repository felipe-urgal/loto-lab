...
Atualizações patch/minor dentro da linha Node 24 podem ser tratadas pelo Dependabot. Mudanças para uma nova major de Node devem ser feitas de forma coordenada entre CI, Docker, `engines`, `.nvmrc`, `.node-version` e tipos, com o pipeline completo verde antes do merge.
